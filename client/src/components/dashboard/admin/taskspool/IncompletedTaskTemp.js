        ...
        <ListItemText
          ...
          secondary={
            <React.Fragment>
              ...
              {props.task.client.contact ? <Box mb={1}> 
              ...
              <Box mb={1}>
                  <Chip icon={<CloudUploadIcon/>} color="secondary" label={<Typography component="h7" variant="subtitle2" >Number of Submissions: {props.task.numberofReviewersAssigned}</Typography>} size="small" /> 
              </Box>
              <Box mb={1}>
              ...
              <Box mb={1}>
                <Chip icon={<AddIcon/>} color="secondary" label={<Typography component="h7" variant="subtitle2" >Number of Submissions required: {props.task.numberofReviewersRequired-props.task.numberOfAcceptedSubmissions}</Typography>} size="small" /> 
              </Box>
              <Box mb={1}>
              ...
              <Box>
              <div align="center">
              {props.task.paused ?  <Chip color={orange[500]} className={classes.orangeAvatar} label={<Typography component="subtitle1"  variant="subtitle2" >Pused</Typography>} size="medium" /> :null} 
             </div>
             </Box>
            </React.Fragment>
          }
